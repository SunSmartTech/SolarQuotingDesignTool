...
export class OrgGrpcControllerBase {
  ...
  @swagger.ApiOkResponse({ type: Org })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("OrgService", "updateOrg")
  async updateOrg(
  ...
  @swagger.ApiOkResponse({ type: Org })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("OrgService", "deleteOrg")
  async deleteOrg(
    @common.Param() params: OrgWhereUniqueInput
  ): Promise<Org | null> {
    try {
  ...
  @GrpcMethod("OrgService", "findManyProjects")
  ...
  @GrpcMethod("OrgService", "connectProjects")
  ...
  @GrpcMethod("OrgService", "updateProjects")
  ...
  @GrpcMethod("OrgService", "disconnectProjects")
