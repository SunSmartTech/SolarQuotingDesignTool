...
export class PaymentOptionGrpcControllerBase {
  ...
  @GrpcMethod("PaymentOptionService", "paymentOptions")
  ...
  @GrpcMethod("PaymentOptionService", "paymentOption")
  async paymentOption(
  ...
  @swagger.ApiOkResponse({ type: PaymentOption })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("PaymentOptionService", "updatePaymentOption")
  ...
  @swagger.ApiOkResponse({ type: PaymentOption })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("PaymentOptionService", "deletePaymentOption")
