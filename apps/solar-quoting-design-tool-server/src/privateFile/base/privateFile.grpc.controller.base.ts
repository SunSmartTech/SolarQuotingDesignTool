...
export class PrivateFileGrpcControllerBase {
  ...
  @GrpcMethod("PrivateFileService", "privateFiles")
  ...
  @GrpcMethod("PrivateFileService", "privateFile")
  async privateFile(
  ...
  @swagger.ApiOkResponse({ type: PrivateFile })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("PrivateFileService", "updatePrivateFile")
  ...
  @swagger.ApiOkResponse({ type: PrivateFile })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("PrivateFileService", "deletePrivateFile")
