...
export class SetbackGrpcControllerBase {
  ...
  @GrpcMethod("SetbackService", "setbacks")
  ...
  @GrpcMethod("SetbackService", "setback")
  async setback(
  ...
  @swagger.ApiOkResponse({ type: Setback })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SetbackService", "updateSetback")
  async updateSetback(
    @common.Param() params: SetbackWhereUniqueInput,
  ...
  @swagger.ApiOkResponse({ type: Setback })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SetbackService", "deleteSetback")
  async deleteSetback(
    @common.Param() params: SetbackWhereUniqueInput
  ): Promise<Setback | null> {
    try {
