...
export class SystemGrpcControllerBase {
  ...
  @GrpcMethod("SystemService", "systems")
  ...
  @GrpcMethod("SystemService", "system")
  async system(
  ...
  @swagger.ApiOkResponse({ type: System })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SystemService", "updateSystem")
  async updateSystem(
    @common.Param() params: SystemWhereUniqueInput,
  ...
  @swagger.ApiOkResponse({ type: System })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("SystemService", "deleteSystem")
  async deleteSystem(
    @common.Param() params: SystemWhereUniqueInput
  ): Promise<System | null> {
    try {
